...
Future versions can add deeper examples, better visual polish, build-card presentation, and additional Formation Ledger packages. The manual does not need every possible branch before it can help players play better.
