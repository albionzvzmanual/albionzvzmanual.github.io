...
| Role | Spread question |
|---|---|
| DPS | Can I still hit something valuable? |
| Healer | Can I still heal the danger area? |
| Support | Can I still cover the active lane? |
| Tank | Am I preserving the front or leaving first? |
| Caller | Did my spread call include enough direction and intent? |

## Training drill

During VOD review, every time "spread" is called, freeze three seconds later. Mark each player as:

- useful spread
- too far / left the fight
- still clumped
- wrong side of terrain
- connected and pressuring
